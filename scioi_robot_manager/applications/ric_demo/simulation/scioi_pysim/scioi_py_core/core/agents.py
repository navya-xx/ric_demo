import applications.ric_demo.simulation.scioi_pysim.scioi_py_core.core.world as world
import applications.ric_demo.simulation.scioi_pysim.scioi_py_core.core.dynamics as dynamics
import applications.ric_demo.simulation.scioi_pysim.scioi_py_core.core.spaces as spaces
...
class Agent(world.WorldObject):
    ...
    def __init__(self, name: str = None, world: world.World = None,
                 space: spaces.Space = None, agent_id: str = '1', *args, **kwargs):
