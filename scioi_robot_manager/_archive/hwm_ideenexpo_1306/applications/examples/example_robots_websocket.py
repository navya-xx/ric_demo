...
frontend_dir = f"{os.path.dirname(__file__)}/../../gui/nodejs_gui/frontend/"
...
def startGUI():
    ...
    frontend_process = subprocess.Popen("npm run dev -- --open", shell=True)
...
def main():
    ...
    signal.signal(signal.SIGINT, closeGUI)
