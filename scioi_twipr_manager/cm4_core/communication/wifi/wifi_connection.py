...
from cm4_core.communication.protocol import Message
from cm4_core.communication.wifi.protocols.tcp_handshake_protocol import TCP_Handshake_Message, TCP_Handshake_Protocol
from cm4_core.communication.wifi.protocols.tcp_base_protocol import TCP_Base_Message, TCP_Base_Protocol
...
import cm4_core.communication.wifi.addresses as addresses
...
class WIFI_Connection:
    ...
    def _sendHandshake(self):
        ...
        # handshake_message.uid = bytes([0, 0])
